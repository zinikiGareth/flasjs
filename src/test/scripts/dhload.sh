...
# Upload 'counter'
scp src/test/javascript/{builtin,dom,flasck,flenv}.js ../FLAS2/src/test/resources/cards/test.ziniki/test.ziniki.js gmmapowell@dh.flasck.net:dh.flasck.net/demos/counterDemo/javascript
sed \
